...
int prefixExpressionEvaluation(string prefix_string)
{
    ...
    for (int i = prefix_string.length() - 1; i >= 0; i--)
    {

        // get next_character from prefix_string
        char next_character = prefix_string[i];
...
int main() {
    cout << "=== Prefix Expression Evaluation (Following Teacher's Pseudocode) ===\n";
    ...
    string testExpressions[] = {
        ...
        "^23",              // ^ 2 3 = 8
        "-+*2345",          // - + * 2 3 4 5 = - + 6 4 5 = - 10 5 = 5
        "*+23-45",          // * + 2 3 - 4 5 = * 5 -1 = -5
        "+23*45"            // + 2 3 * 4 5 = 5 20 (invalid - not proper prefix)
    };
    ...
    for (int i = 0; i < 10; i++) {
        ...
        int result = prefixExpressionEvaluation(testExpressions[i]);
